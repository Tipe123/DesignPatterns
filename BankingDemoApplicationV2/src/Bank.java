...
* This class is responsible for the banking information
* */
...
public class Bank {
    ...
    public int newAccount() {
        int newaccount =nextacct++;
        accounts.put(newaccount,0);
        return newaccount;
    }
    ...
    public String toString(){
        ...
        String result = "The back has " + accts.size() + " accounts.";
        for(int i : accts)
            result += "\n\tBank account "+ i + ": balance = "+ accounts.get(i).toString();
        return result;
    }
